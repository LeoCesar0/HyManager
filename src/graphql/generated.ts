...
export type BankAccountManyWhereInput = {
  ...
  transaction_empty?: InputMaybe<Scalars['Boolean']>;
  /** Matches if the union contains at least one connection to the provided item to the filter */
  transaction_some?: InputMaybe<BankAccountBankAccounts_TransactionsWhereInput>;
  updatedAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  updatedAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
...
export type PublishManyTransactionsMutationVariables = Exact<{
  bankAccountId: Scalars['ID'];
}>;


export type PublishManyTransactionsMutation = { __typename?: 'Mutation', publishManyTransactions: { __typename?: 'BatchPayload', count: any } };
...
export const PublishManyTransactionsDocument = gql`
    mutation PublishManyTransactions($bankAccountId: ID!) {
  publishManyTransactions(
    ...
    `;
export type PublishManyTransactionsMutationFn = Apollo.MutationFunction<PublishManyTransactionsMutation, PublishManyTransactionsMutationVariables>;

/**
 * __usePublishManyTransactionsMutation__
 *
 * To run a mutation, you first call `usePublishManyTransactionsMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `usePublishManyTransactionsMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [publishManyTransactionsMutation, { data, loading, error }] = usePublishManyTransactionsMutation({
 *   variables: {
 *      bankAccountId: // value for 'bankAccountId'
 *   },
 * });
 */
export function usePublishManyTransactionsMutation(baseOptions?: Apollo.MutationHookOptions<PublishManyTransactionsMutation, PublishManyTransactionsMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<PublishManyTransactionsMutation, PublishManyTransactionsMutationVariables>(PublishManyTransactionsDocument, options);
      }
export type PublishManyTransactionsMutationHookResult = ReturnType<typeof usePublishManyTransactionsMutation>;
export type PublishManyTransactionsMutationResult = Apollo.MutationResult<PublishManyTransactionsMutation>;
export type PublishManyTransactionsMutationOptions = Apollo.BaseMutationOptions<PublishManyTransactionsMutation, PublishManyTransactionsMutationVariables>;
